...
adicionadorlistaclientesdescentendes($arraybyorden);
...
?>
       </p> <hr />	<form method="post" action="ClientesAcendente">
    <p>
        <input type="submit" name="save" value="ascendente" />
    </p>
</form>

    <form method="post" action="ClientesDescendente">
    <p>
        <input type="submit" name="save" value="descendente" />
    </p>
</form>
