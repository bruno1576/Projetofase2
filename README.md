...
>O projeto precisa ser execultado por um servidor,nele você podera encontrar uma listagem de clientes onde podera ser ordenada >de forma acendende ou descendente.